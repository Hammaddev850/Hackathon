...
function Header() {
    ...
    return (
        <header className="bg-black text-white">
            ...
            <nav
                className={`md:hidden fixed top-0 left-0 w-full h-full bg-black text-white z-20 transition-transform duration-300 ${isMenuOpen ? 'transform translate-x-0' : 'transform -translate-x-full'}`}
            >
